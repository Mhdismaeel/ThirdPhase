...
Route::group(['middleware' => ['auth:api','HttpLog']], function() {
...
Route::post('login', 'Auth\LoginController@login')->middleware('HttpLog');
Route::get('UserVirification/{email}','UsersController@VerificationUser');

Route::get('GetAllType', 'TicketTypeController@index')->middleware('HttpLog');
Route::get('GetType/{slug}', 'TicketTypeController@show')->middleware('HttpLog');
//********************************Ticket Priority */
Route::get('GetAllPriority', 'TicketPriorityController@index')->middleware('HttpLog');
Route::get('GetPriority/{slug}', 'TicketPriorityController@show')->middleware('HttpLog');
//*****************//*/
Route::get('ProjectActivityLog/{projectid}', 'LogController@GetProjectAllActivity')->middleware('HttpLog');
